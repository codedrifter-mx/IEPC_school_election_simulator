...
class AdminValidateTable extends DataTableComponent
{
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Fecha de fin', 'end_at')
                ...
                ->html(),
            Column::make('Validar', 'event_key')
                ->label(fn($row) => '<button onclick="validateEvent(`' . $row->event_key . '`)" class="btn btn-primary btn-sm">Validar</button>')
                ->html(),
        ];
    }
